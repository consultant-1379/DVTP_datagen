...
public class DataUsage extends SgwEvent
{
    ...
    static 
    {
        ...
        eventFormat.add(new SgwEventFormat(com.ericsson.cac.ecds.sgw.eventparameter.base.BearerUsageStruct.class, "BEARER_USAGE_STRUCT", true));
        eventFormat.add(new SgwEventFormat(com.ericsson.cac.ecds.sgw.eventparameter.base.SessionUsageStruct.class, "SESSION_USAGE_STRUCT", true));
        /*
